...
<body>
    ...
    <script>
        ...
        generateReportButton.addEventListener('click', function () {
            fetch(`virusreports/generate/${citySelect.value}/${brgySelect.value}`).then(response => {
                if (response.ok) {
                ...
                const reportTotalElement = document.getElementById('report_total');

                reportTotalElement.innerHTML = `Total Number of Persons With Corona Virus: ${total}`;
